...
| 5 | dbt-analytics-engineering | SaaS metrics-as-code (ARR, NRR, churn) |
| 6 | healthcare-dimensional-model | EHR/claims dimensional model + DQ |
...
5. **[healthcare-dimensional-model](healthcare-dimensional-model/)** — Healthcare BI patterns
6. **[dbt-analytics-engineering](dbt-analytics-engineering/)** — Analytics engineering / SaaS metrics
7. **[github-profile](github-profile/)** — Profile README for `rohithg/rohithg`

Publish each folder to its own public repo: see **[PUBLISH.md](PUBLISH.md)** and `scripts/publish-all.sh`.
